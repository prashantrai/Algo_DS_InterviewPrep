...
public class SimpleBankingSystem {
	...
	public static void test_Level_3() {
        ...
        // Make payments
        System.out.println(bankingSystem.pay(4, "account1", 1000).get()); // Optional[payment1]
        System.out.println(bankingSystem.pay(100, "account1", 1000).get()); // Optional[payment2]
    ...
    public Optional<String> getPaymentStatus(int timestamp, String accountId, String paymentId) {
        ...
        if (timestamp >= payment.cashbackTime) {
            return Optional.of("CASHBACK RECEIVED");
        }
