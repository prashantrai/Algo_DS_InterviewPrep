...
public class KokoEatingBananas_875_Medium {
     ...
     *  In Brute force, we can start with speed = 1, and for each speed value we will compare the if Koko  is able to finish in <= h hours, else increment speed by 1 and repeat.
     *  
     *  Binary Search: 
