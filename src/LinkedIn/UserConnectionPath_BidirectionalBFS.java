...
public class UserConnectionPath_BidirectionalBFS {
	 ...
	 * 
	 * Follw-up: 
     * Follow up: What is Bob has multiple users or bob is a celeb and Frank is also a celeb. The idea was to start with bi-directional BFS.
     * 
     * High-Level Steps
     ...
     */
    public List<String> findConnectionPathBiBFS(
     ...
     */
    private List<String> buildBiPath(
        String meetingNode,
    ...
    public static void main(String[] args) {
        UserConnectionPath solver = new UserConnectionPath();
        ...
        System.out.println(solver.findConnectionPathBiBFS(graph, "Bob", "George"));
        // Bob → Alice → Franck → George

        // symmetric path
        System.out.println(solver.findConnectionPathBiBFS(graph, "George", "Bob"));
        // George → Franck → Alice → Bob

        // trivial case
        System.out.println(solver.findConnectionPathBiBFS(graph, "Bob", "Bob"));
        // [Bob]

        // no path
        System.out.println(solver.findConnectionPathBiBFS(graph, "Bob", "Zoe"));
        // []
    }
}
