...
public class PatternMatchingDemo {
	...
	public static boolean doesMatch(String pattern, String value) {
		...
		for (int mainSize = 0; mainSize <= maxMainSize; mainSize++) {
			...
			if (countOfAlt == 0 || remainingLength % countOfAlt == 0) {  //-- mod : if it's ZERO then remainLength could be only Alt and cond should be true to build that string
	...
	public static void main(String[] args) {
		...
		String value = "backbatbackbatbat";
		System.out.println(pattern + ", " + value + ": " + doesMatch(pattern, value));
