...
/*
 * https://github.com/prashantrai/CtCI-6th-Edition/tree/master/Java/Ch%2010.%20Sorting%20and%20Searching/Q10_09_Sorted_Matrix_Search
 * */

public class SortedMatrixSearchQuestionB {
	...
	public static void main(String[] args) {
		...
		CtCILibrary.AssortedMethods.printMatrix(matrix);  //--package CtCILibrary
		int m = matrix.length;
	...
	public static Coordinate findElement(int[][] matrix, Coordinate origin, Coordinate dest, int x) {
		...
		/*
		 * Do binary search on the diagonal, looking for the first element greater than
		 * x
		 */
