...
public class ZigZagOrderTreeTraversal_103_Medium {
	...
	// --
	//-- Look at the comment section :: https://medium.com/@harycane/binary-tree-zigzag-level-order-traversal-5b96a3e1b767
	...
	public static List<List<Integer>> zigzagLevelOrder(TreeNode root) {
		...
		while (!q.isEmpty()) {
			...
			for (int i = 0; i < size; i++) {
				...
				if (leftToRight) {
					/* there is element shifting cost involve if use  and that will lead this to O(n^2)  
					 * this can be solved with LinkedList as we don't need to shift 
					 * element but to add the new one at head time complexity will be O(n) with linkedlist
					 */
