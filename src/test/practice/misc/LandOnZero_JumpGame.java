...
public class LandOnZero_JumpGame {
	 ...
	 * you will move left or right from current position by the steps of value at current index
	 * and then your new start index will be this value to traverse left or right
	 */
	...
	//--Working solution. It has a bug: it will throw StackOverFlow if the dups e.g. {1,2,2,1}
